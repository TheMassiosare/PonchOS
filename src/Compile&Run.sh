...
i386-elf-ld -o "full_kernel.bin" -Ttext 0x1000 "Kernel_entry.o" "Kernel.o" "Utils.o" "IDT.o" "ISRs_c.o" "ISRs_asm.o" "IRQs_c.o" "IRQs_asm.o" "Cursor.o" "Timer.o" --oformat binary 
